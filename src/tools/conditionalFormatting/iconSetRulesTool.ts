...
export const iconSetRulesTool = new FileBasedTool(
    "icon_set_rules",
        ...
        z.object({
            ...
            rule: z.object({
                ...
                options: z.object({
                    ...
                    reverseIcons: z.boolean().optional(),
        ...
        z.object({
            ...
            rule: z.object({
                ...
                options: z.object({
                    ...
                    reverseIcons: z.boolean().nullable(),
                    iconOnly: z.boolean().nullable()
                }).nullable()
            }).nullable(),
    ...
    async (cmd, ctx) => {
        ...
        return {
            file: workbook,
            output: {
                message: `IconSet rule added`,
                range: cmd.args.range,
                rule: {
                    type: cmd.args.rule.type,
                    iconSet: cmd.args.rule.iconSet
                }
            }
        };
    },
