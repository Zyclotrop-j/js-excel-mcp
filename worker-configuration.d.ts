/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6f4f5d0bd1eb81070a5ee4687ebfc5ee)
...
interface __BaseEnv_Env {
	...
	NODE_ENV: "production";
	MCP_AUTH_MODE: "real";
	MCP_AUTH_BIND_HOST: "0.0.0.0";
	MCP_AUTH_CORS_ORIGINS: "http://localhost:3000,http://localhost:5173";
	MCP_AUTH_ALLOW_USER_SIGNUP: "1";
	MCP_AUTH_OTP_TRANSPORT: "console";
	MCP_AUTH_DB_BACKEND: "d1";
	MCP_AUTH_DB_URL: "AUTH";
	AUTH_SECRET: string;
	SESSION_STATE: DurableObjectNamespace<import("./src/index").SessionStateDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SessionStateDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKEND" | "NODE_ENV" | "MCP_AUTH_MODE" | "MCP_AUTH_BIND_HOST" | "MCP_AUTH_CORS_ORIGINS" | "MCP_AUTH_ALLOW_USER_SIGNUP" | "MCP_AUTH_OTP_TRANSPORT" | "MCP_AUTH_DB_BACKEND" | "MCP_AUTH_DB_URL" | "AUTH_SECRET">> {}
}
